...
// SparqlParserListener is a complete listener for a parse tree produced by SparqlParser.
type SparqlParserListener interface {
	...
	// EnterAggregateProjection is called when entering the aggregateProjection production.
	EnterAggregateProjection(c *AggregateProjectionContext)
	...
	// ExitAggregateProjection is called when exiting the aggregateProjection production.
	ExitAggregateProjection(c *AggregateProjectionContext)
